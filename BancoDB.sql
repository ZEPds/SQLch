...
GRANT SELECT ON TABLE `DB_BANCO`.* TO 'user1';
CREATE USER 'user2';

GRANT SELECT, INSERT, TRIGGER ON TABLE `DB_BANCO`.* TO 'user2';
GRANT SELECT, INSERT, TRIGGER, UPDATE ON TABLE `DB_BANCO`.* TO 'user2';
GRANT SELECT ON TABLE `DB_BANCO`.* TO 'user2';
