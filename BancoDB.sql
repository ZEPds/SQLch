...
START TRANSACTION;
USE `DB_BANCO`;
INSERT INTO `DB_BANCO`.`Transaccion` (`idTransaccion`, `idCliente`, `idBanco`, `monto`, `tipo`, `estado`, `errorT`) VALUES (1, 1, 3, 1500, 1, 2, NULL);
INSERT INTO `DB_BANCO`.`Transaccion` (`idTransaccion`, `idCliente`, `idBanco`, `monto`, `tipo`, `estado`, `errorT`) VALUES (2, 1, 2, 300, 2, 5, 3);
INSERT INTO `DB_BANCO`.`Transaccion` (`idTransaccion`, `idCliente`, `idBanco`, `monto`, `tipo`, `estado`, `errorT`) VALUES (3, 3, 1, 500, 1, 1, NULL);
INSERT INTO `DB_BANCO`.`Transaccion` (`idTransaccion`, `idCliente`, `idBanco`, `monto`, `tipo`, `estado`, `errorT`) VALUES (4, 4, 4, 300, 1, 5, 1);
