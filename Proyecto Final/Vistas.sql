...
-- -----------------------------------------------------
-- Placeholder table for view `DB_BANCO`.`vwclientes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DB_BANCO`.`vwclientes` (`id` INT, `nombre` INT, `cuenta` INT, `nacimiento` INT);

-- -----------------------------------------------------
-- Placeholder table for view `DB_BANCO`.`vwoperacion`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DB_BANCO`.`vwoperacion` (`idTransaccion` INT, `idCliente` INT, `idBanco` INT, `monto` INT, `tipo` INT, `estado` INT, `errorT` INT);

-- -----------------------------------------------------
-- Placeholder table for view `DB_BANCO`.`vwOpError`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DB_BANCO`.`vwOpError` (`idTransaccion` INT, `idCliente` INT, `idBanco` INT, `monto` INT, `tipo` INT, `estado` INT, `errorT` INT);

-- -----------------------------------------------------
-- Placeholder table for view `DB_BANCO`.`vwTarjetaClave`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DB_BANCO`.`vwTarjetaClave` (`id` INT, `cuenta` INT, `tarjeta` INT, `clave` INT);

-- -----------------------------------------------------
-- Placeholder table for view `DB_BANCO`.`vwErrores`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DB_BANCO`.`vwErrores` (`idErrores` INT, `nombre` INT);

-- -----------------------------------------------------
-- View `DB_BANCO`.`vwclientes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB_BANCO`.`vwclientes`;
DROP VIEW IF EXISTS `DB_BANCO`.`vwclientes` ;
USE `DB_BANCO`;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB_BANCO`.`vwoperacion`;
DROP VIEW IF EXISTS `DB_BANCO`.`vwoperacion` ;
USE `DB_BANCO`;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB_BANCO`.`vwOpError`;
DROP VIEW IF EXISTS `DB_BANCO`.`vwOpError` ;
USE `DB_BANCO`;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB_BANCO`.`vwTarjetaClave`;
DROP VIEW IF EXISTS `DB_BANCO`.`vwTarjetaClave` ;
USE `DB_BANCO`;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB_BANCO`.`vwErrores`;
DROP VIEW IF EXISTS `DB_BANCO`.`vwErrores` ;
USE `DB_BANCO`;
